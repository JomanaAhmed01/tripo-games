...
function RobotrixPlayability() {
    return (
        <Wrapper>
            <TextWrapper>
                <Header>Open-world playability wherever you are</Header>
...
export const Wrapper = styled.div`
  background-image: url('./img/robotrix-game-bg-two.png');
...
export default RobotrixPlayability;